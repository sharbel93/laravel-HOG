...
@section('content')
    <!-- Start Page Header -->
    <div class="page-header parallax clearfix" style="background-image:url({{ asset('files/images/ph7.jpg') }});">
                        ...
                        <div class="element-block events-listing">
                            <div class="events-listing-header">
                                <ul class="sort-source" data-sort-id="events" data-option-key="filter">
                                    <li data-option-value="*" class="active"><a href="{{ url('/event')}}#">Show All</a></li>
                                    <li data-option-value=".fests"><a href="{{ url('/event')}}#">Fests</a></li>
                                    <li data-option-value=".meetings"><a href="{{ url('/event')}}#">Meetings</a></li>
                                    <li data-option-value=".prayers"><a href="{{ url('/event')}}#">Prayers</a></li>
                                    <li data-option-value=".celebrations"><a href="{{ url('/event')}}#">Celebrations</a></li>
                                </ul>
                            </div>
                            <ul class="events-listing-content sort-destination isotope-events" data-sort-id="events">
                                <li class="event-list-item event-dynamic grid-item prayers celebrations">
                                    ...
                                    <div class="event-list-item-info">
                                        <div class="lined-info">
                                            <h4><a href="{{ url('/single-event')}}" class="event-title">Water Baptism</a></h4>
                                        </div>
                                        <div class="lined-info">
                                    ...
                                    <div class="event-list-item-actions">
                                        <a href="{{ url('/event')}}#" class="btn btn-default btn-transparent event-tickets event-register-button">Register</a>
                                        <ul class="action-buttons">
                                            <li title="Share event"><a href="{{ url('/event')}}#" data-trigger="focus" data-placement="top" data-content="" data-toggle="popover" data-original-title="Share Event" class="event-share-link"><i class="icon-share"></i></a></li>
                                            <li title="Get directions" class="hidden-xs"><a href="{{ url('/event')}}#" class="cover-overlay-trigger event-direction-link"><i class="icon-compass"></i></a></li>
                                            <li title="Contact event manager"><a href="{{ url('/event')}}#" data-toggle="modal" data-target="#Econtact" class="event-contact-link"><i class="icon-mail"></i></a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="event-list-item event-dynamic grid-item meetings">
                                    ...
                                    <div class="event-list-item-info">
                                        <div class="lined-info">
                                            <h4><a href="{{ url('/single-event')}}" class="event-title">Sunday Meet Up</a></h4>
                                        </div>
                                        <div class="lined-info">
                                ...
                                <li class="event-list-item event-dynamic grid-item prayers">
                                    ...
                                    <div class="event-list-item-info">
                                        <div class="lined-info">
                                            <h4><a href="{{ url('/single-event')}}" class="event-title">Holy shift: Strategic think</a></h4>
                                        </div>
                                        <div class="lined-info">
                                            <span class="meta-data"><i class="fa fa-clock-o"></i> Monday, <span class="event-time">10:00 AM</span></span>
                                        </div>
